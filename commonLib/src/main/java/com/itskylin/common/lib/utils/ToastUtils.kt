...
object ToastUtils {
    ...
    private fun showToast(@StringRes resId: Int, duration: Int) {
        showToast(CommonUtils.getContext().resources.getText(resId).toString(), duration)
    }
    ...
    private fun showToast(@StringRes resId: Int, duration: Int, vararg args: Any) {
        showToast(String.format(CommonUtils.getContext().resources.getString(resId), *args), duration)
    }
    ...
    private fun showToast(text: CharSequence, duration: Int) {
        ...
        if (sToast == null) {
            ...
            val tv = sToast!!.view.findViewById<View>(android.R.id.message) as TextView
            tv.textSize = 18f
